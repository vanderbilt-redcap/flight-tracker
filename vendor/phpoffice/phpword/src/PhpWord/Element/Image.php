...
class Image extends AbstractElement
{
	 ...
	 */
	public const SOURCE_LOCAL = 'local'; // Local images
	public const SOURCE_GD = 'gd'; // Generated using GD
	public const SOURCE_ARCHIVE = 'archive'; // Image in archives zip://$archive#$image
	public const SOURCE_STRING = 'string'; // Image from string
