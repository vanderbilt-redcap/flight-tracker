...
abstract class AbstractPart
{
	 ...
	 * @const int
	 */
	public const READ_VALUE = 'attributeValue';            // Read attribute value
	public const READ_EQUAL = 'attributeEquals';           // Read `true` when attribute value equals specified value
	public const READ_TRUE = 'attributeTrue';              // Read `true` when element exists
	public const READ_FALSE = 'attributeFalse';            // Read `false` when element exists
	public const READ_SIZE = 'attributeMultiplyByTwo';     // Read special attribute value for Font::$size
