...
class Converter
{
	...
	public const INCH_TO_TWIP = 1440;
	public const INCH_TO_PIXEL = 96;
	public const INCH_TO_POINT = 72;
	public const INCH_TO_PICA = 6;
	public const PIXEL_TO_EMU = 9525;
	public const DEGREE_TO_ANGLE = 60000;
