...
class RubyProperties
{
	...
	public const ALIGNMENT_DISTRIBUTE_LETTER = 'distributeLetter';
	public const ALIGNMENT_DISTRIBUTE_SPACE = 'distributeSpace';
	public const ALIGNMENT_LEFT = 'left';
	public const ALIGNMENT_RIGHT = 'right';
	public const ALIGNMENT_RIGHT_VERTICAL = 'rightVertical';
