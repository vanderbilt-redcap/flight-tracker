...
{
	public const RESTART_NUMBER_CONTINUOUS = 'continuous';
	public const RESTART_NUMBER_EACH_SECTION = 'eachSect';
	public const RESTART_NUMBER_EACH_PAGE = 'eachPage';

	public const POSITION_PAGE_BOTTOM = 'pageBottom';
	public const POSITION_BENEATH_TEXT = 'beneathText';
	public const POSITION_SECTION_END = 'sectEnd';
	public const POSITION_DOC_END = 'docEnd';
