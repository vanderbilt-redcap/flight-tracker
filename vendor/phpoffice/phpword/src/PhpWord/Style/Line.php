...
class Line extends Image
{
	 ...
	 * @const string
	 */
	public const CONNECTOR_TYPE_STRAIGHT = 'straight';
	 ...
	 * @const string
	 */
	public const ARROW_STYLE_BLOCK = 'block';
	public const ARROW_STYLE_OPEN = 'open';
	public const ARROW_STYLE_CLASSIC = 'classic';
	public const ARROW_STYLE_DIAMOND = 'diamond';
	public const ARROW_STYLE_OVAL = 'oval';
	...
	public const DASH_STYLE_ROUND_DOT = 'rounddot';
	public const DASH_STYLE_SQUARE_DOT = 'squaredot';
