...
class Shading extends AbstractStyle
{
	 ...
	 */
	public const PATTERN_CLEAR = 'clear'; // No pattern
	public const PATTERN_SOLID = 'solid'; // 100% fill pattern
	public const PATTERN_HSTRIPE = 'horzStripe'; // Horizontal stripe pattern
	public const PATTERN_VSTRIPE = 'vertStripe'; // Vertical stripe pattern
	public const PATTERN_DSTRIPE = 'diagStripe'; // Diagonal stripe pattern
	public const PATTERN_HCROSS = 'horzCross'; // Horizontal cross pattern
	public const PATTERN_DCROSS = 'diagCross'; // Diagonal cross pattern
