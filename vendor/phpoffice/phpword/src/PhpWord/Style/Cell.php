...
class Cell extends Border
{
	 ...
	 */
	public const TEXT_DIR_LRTB = 'lrTb';
	/**
	 * Top to Bottom, Right to Left.
	 */
	public const TEXT_DIR_TBRL = 'tbRl';
	/**
	 * Bottom to Top, Left to Right.
	 */
	public const TEXT_DIR_BTLR = 'btLr';
	/**
	 * Left to Right, Top to Bottom Rotated.
	 */
	public const TEXT_DIR_LRTBV = 'lrTbV';
	/**
	 * Top to Bottom, Right to Left Rotated.
	 */
	public const TEXT_DIR_TBRLV = 'tbRlV';
	/**
	 * Top to Bottom, Left to Right Rotated.
	 */
	public const TEXT_DIR_TBLRV = 'tbLrV';
	 ...
	 * @const string
	 */
	public const VMERGE_RESTART = 'restart';
	public const VMERGE_CONTINUE = 'continue';
	 ...
	 * @const string
	 */
	public const DEFAULT_BORDER_COLOR = '000000';
