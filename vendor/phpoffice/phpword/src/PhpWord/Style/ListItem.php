...
{
	public const TYPE_SQUARE_FILLED = 1;
	public const TYPE_BULLET_FILLED = 3; // default
	public const TYPE_BULLET_EMPTY = 5;
	public const TYPE_NUMBER = 7;
	public const TYPE_NUMBER_NESTED = 8;
	public const TYPE_ALPHANUM = 9;
