...
class Section extends Border
{
	 ...
	 * @const int|float
	 */
	public const DEFAULT_WIDTH = 11905.511811024; // In twips.
	public const DEFAULT_HEIGHT = 16837.79527559; // In twips.
	public const DEFAULT_GUTTER = 0;              // In twips.
	public const DEFAULT_HEADER_HEIGHT = 720;     // In twips.
	public const DEFAULT_FOOTER_HEIGHT = 720;     // In twips.
	public const DEFAULT_COLUMN_COUNT = 1;
	public const DEFAULT_COLUMN_SPACING = 720;    // In twips.
