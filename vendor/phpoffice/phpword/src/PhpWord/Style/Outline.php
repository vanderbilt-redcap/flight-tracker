...
class Outline extends AbstractStyle
{
	 ...
	 * @const string
	 */
	public const LINE_SINGLE = 'single';
	public const LINE_THIN_THIN = 'thinThin';
	public const LINE_THIN_THICK = 'thinThick';
	public const LINE_THICK_THIN = 'thickThin';
	public const LINE_THICK_BETWEEN_THIN = 'thickBetweenThin';
	 ...
	 * @const string
	 */
	public const ENDCAP_FLAT = 'flat';
	public const ENDCAP_SQUARE = 'square';
	public const ENDCAP_ROUND = 'round';
	...
	public const ARROW_BLOCK = 'block';
	public const ARROW_CLASSIC = 'classic';
	public const ARROW_OVAL = 'oval';
	public const ARROW_DIAMOND = 'diamond';
	public const ARROW_OPEN = 'open';
