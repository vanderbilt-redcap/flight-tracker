...
class Frame extends AbstractStyle
{
	 ...
	 * @const string
	 */
	public const UNIT_PT = 'pt'; // Mostly for shapes
	public const UNIT_PX = 'px'; // Mostly for images
	 ...
	 * @const string
	 */
	public const POS_ABSOLUTE = 'absolute';
	public const POS_RELATIVE = 'relative';
	...
	public const POS_INSIDE = 'inside';
	public const POS_OUTSIDE = 'outside';
	 ...
	 * @const string
	 */
	public const POS_RELTO_MARGIN = 'margin';
	public const POS_RELTO_PAGE = 'page';
	public const POS_RELTO_COLUMN = 'column'; // horizontal only
	public const POS_RELTO_CHAR = 'char'; // horizontal only
	public const POS_RELTO_TEXT = 'text'; // vertical only
	public const POS_RELTO_LINE = 'line'; // vertical only
	public const POS_RELTO_LMARGIN = 'left-margin-area'; // horizontal only
	public const POS_RELTO_RMARGIN = 'right-margin-area'; // horizontal only
	public const POS_RELTO_TMARGIN = 'top-margin-area'; // vertical only
	public const POS_RELTO_BMARGIN = 'bottom-margin-area'; // vertical only
	public const POS_RELTO_IMARGIN = 'inner-margin-area';
	public const POS_RELTO_OMARGIN = 'outer-margin-area';
	 ...
	 * @const string
	 */
	public const WRAP_INLINE = 'inline';
	public const WRAP_SQUARE = 'square';
	public const WRAP_TIGHT = 'tight';
	public const WRAP_THROUGH = 'through';
	public const WRAP_TOPBOTTOM = 'topAndBottom';
	public const WRAP_BEHIND = 'behind';
	public const WRAP_INFRONT = 'infront';
