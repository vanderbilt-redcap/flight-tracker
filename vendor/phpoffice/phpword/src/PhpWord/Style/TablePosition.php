...
class TablePosition extends AbstractStyle
{
	 ...
	 */
	public const VANCHOR_TEXT = 'text'; // Relative to vertical text extents
	public const VANCHOR_MARGIN = 'margin'; // Relative to margin
	public const VANCHOR_PAGE = 'page'; // Relative to page
	 ...
	 */
	public const HANCHOR_TEXT = 'text'; // Relative to text extents
	public const HANCHOR_MARGIN = 'margin'; // Relative to margin
	public const HANCHOR_PAGE = 'page'; // Relative to page
	 ...
	 */
	public const XALIGN_LEFT = 'left'; // Left aligned horizontally
	public const XALIGN_CENTER = 'center'; // Centered horizontally
	public const XALIGN_RIGHT = 'right'; // Right aligned horizontally
	public const XALIGN_INSIDE = 'inside'; // Inside
	public const XALIGN_OUTSIDE = 'outside'; // Outside
	 ...
	 */
	public const YALIGN_INLINE = 'inline'; // In line with text
	public const YALIGN_TOP = 'top'; // Top
	public const YALIGN_CENTER = 'center'; // Centered vertically
	public const YALIGN_BOTTOM = 'bottom'; // Bottom
	public const YALIGN_INSIDE = 'inside'; // Inside Anchor Extents
	public const YALIGN_OUTSIDE = 'outside'; // Centered vertically
