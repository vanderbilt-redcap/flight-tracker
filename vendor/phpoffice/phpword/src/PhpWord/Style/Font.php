...
class Font extends AbstractStyle
{
	...
	public const UNDERLINE_DOTDASH = 'dotDash';
	public const UNDERLINE_DOTDASHHEAVY = 'dotDashHeavy';
	 ...
	 * @const string
	 */
	public const FGCOLOR_YELLOW = 'yellow';
	public const FGCOLOR_LIGHTGREEN = 'green';
	public const FGCOLOR_CYAN = 'cyan';
	public const FGCOLOR_MAGENTA = 'magenta';
	public const FGCOLOR_BLUE = 'blue';
	public const FGCOLOR_RED = 'red';
	public const FGCOLOR_DARKBLUE = 'darkBlue';
	public const FGCOLOR_DARKCYAN = 'darkCyan';
	public const FGCOLOR_DARKGREEN = 'darkGreen';
	public const FGCOLOR_DARKMAGENTA = 'darkMagenta';
	public const FGCOLOR_DARKRED = 'darkRed';
	public const FGCOLOR_DARKYELLOW = 'darkYellow';
	public const FGCOLOR_DARKGRAY = 'darkGray';
	public const FGCOLOR_LIGHTGRAY = 'lightGray';
	public const FGCOLOR_BLACK = 'black';
