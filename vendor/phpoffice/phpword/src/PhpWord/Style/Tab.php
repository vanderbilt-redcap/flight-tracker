...
class Tab extends AbstractStyle
{
	 ...
	 * @const string
	 */
	public const TAB_STOP_CLEAR = 'clear';
	public const TAB_STOP_LEFT = 'left';
	public const TAB_STOP_CENTER = 'center';
	public const TAB_STOP_RIGHT = 'right';
	public const TAB_STOP_DECIMAL = 'decimal';
	public const TAB_STOP_BAR = 'bar';
	public const TAB_STOP_NUM = 'num';
	 ...
	 * @const string
	 */
	public const TAB_LEADER_NONE = 'none';
	public const TAB_LEADER_DOT = 'dot';
	public const TAB_LEADER_HYPHEN = 'hyphen';
	public const TAB_LEADER_UNDERSCORE = 'underscore';
	public const TAB_LEADER_HEAVY = 'heavy';
	public const TAB_LEADER_MIDDLEDOT = 'middleDot';
