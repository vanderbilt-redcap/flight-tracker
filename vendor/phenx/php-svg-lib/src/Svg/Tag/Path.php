...
class Path extends Shape
{
	...
	public const NUMBER_PATTERN = '([-+]?(?:\d*\.\d+|\d+\.?)(?:[eE][-+]?\d+)?)\s*';
	public const COMMA_PATTERN = '(?:\s+,?\s*|,\s*)?';
	public const FLAG_PATTERN = '([01])';
	public const ARC_REGEXP = '/'
		. self::NUMBER_PATTERN
		. self::COMMA_PATTERN
		. self::NUMBER_PATTERN
		. self::COMMA_PATTERN
	...
	public function drawArc(SurfaceInterface $surface, $fx, $fy, $coords) {
		$rx = $coords[0];
		$ry = $coords[1];
		$rot = $coords[2];
		$large = $coords[3];
