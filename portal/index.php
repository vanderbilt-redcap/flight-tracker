...
echo "<div id='welcomeMessage' style='display: none;'><p>Administrators and program directors are tracking your career development through the below REDCap-based project(s). These help them with reporting to funding agencies and ensuring excellent service. With the Scholar Portal, you can track these metrics as well.</p><p>First, select one of the projects listed below. <strong>Your Graphs</strong> and <strong>Your Info</strong> show key metrics related to your professional progress. You can correct any inaccuracies under <strong>Your Info &rarr; Update</strong>. You can also look for colleagues in various research areas by exploring <strong>Your Network</strong>. Please <span class='multiProject'>click to select a project below, </span>explore your data through the menu options<span class='multiProject'>,</span> and build your career!</p></div>";
echo "<div id='noDataMessage' style='display: none;'>Welcome! You are not currently tracked by Flight Tracker on this REDCap server. Sorry! You can check out the <a href='#board' onclick='portal.takeAction(\"board\", \"Bulletin Board\"); return false;'>Institutional Bulletin Board</a>.</div>";
