...
class CohortStudy extends Study
{
	...
	public function getN($type = "unpaired") {
		...
		} elseif (strtolower($type) == "treatment") {
			return $this->treatment->getN();
		} elseif (strtolower($type) == "unpaired") {
	...
	public static function estimateDegreesOfFreedom($degreesOfFreedom) {
		if ($degreesOfFreedom > 100) {
			return 1000;
		} elseif ($degreesOfFreedom > 80) {
			return 100;
		} elseif ($degreesOfFreedom > 60) {
			return 80;
		} elseif ($degreesOfFreedom > 40) {
			return 60;
		} elseif ($degreesOfFreedom > 30) {
			return 40;
		} else {
