...
class OpenAI {
    const ENDPOINT = "https://vumc-openai-24.openai.azure.com/";
    const NO_DATA = "No data";
    const NUM_KEYWORDS = 5;
    const CITATION_KEYWORD_FIELD = "citation_ai_keywords";
    const SEPARATOR = ";";
    const NUM_TOPIC_KEYWORDS = 7;
    ...
    public static function downloadURLWithPOST(string $url, array $postdata = [], int $pid = NULL, array $addlOpts = [], int $autoRetriesLeft = 3, int $longRetriesLeft = 2, string $defaultFormat = "json"): array {
