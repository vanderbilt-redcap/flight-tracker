...
class Portal
{
    ...
    public function findCollaboratorPage() {
        ...
        $html .= MeSHTerms::makeHTMLTable(self::NUM_SEARCH_MESH_TERMS, $this->pid ?: $this->getFirstPid(), "portal.searchForTopics(\"{$this->driverURL}\", portal.compileMeSHTerms(".self::NUM_SEARCH_MESH_TERMS."), \"citation_mesh_terms\"); return false;");
