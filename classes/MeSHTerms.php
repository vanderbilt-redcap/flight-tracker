...
class MeSHTerms
{
	public const CURRENT_MESH_TERMS = "current_mesh_terms";
	public const SUPPLEMENTAL_MESH_TERMS = "supplemental_mesh_terms";
	public const MESH_SEPARATOR = "\n";
	...
	public static function makeHTMLTable(int $numTerms, $pid, $searchAction = ""): string {
		...
		if ($searchAction !== "") {
			$html .= "<tr><td colspan='2' class='centered'><div class='meshOverlay'></div><button onclick='$searchAction'>Search</button></td></tr>";
		}
		$html .= "</tbody></table>";
