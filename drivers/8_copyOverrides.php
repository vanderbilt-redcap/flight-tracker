...
$data = [
	...
	'format' => 'json',
	'type' => 'flat',
	'fields' => ['identifier_email', 'record_id', 'identifier_last_name', 'identifier_first_name'],
	'rawOrLabel' => 'raw',
...
$data = [
	...
	'format' => 'json',
	'type' => 'flat',
	'fields' => ['identifier_email', 'identifier_last_name', 'identifier_first_name', 'record_id'],
	'rawOrLabel' => 'raw',
	'rawOrLabelHeaders' => 'raw',
	'exportCheckboxLabel' => 'false',
	'exportSurveyFields' => 'false',
...
foreach ($redcapData as $row) {
	foreach ($backupData as $row2) {
		if (($row2['identifier_first_name'] == $row['identifier_first_name']) && ($row['identifier_last_name'] == $row2['identifier_last_name']) && ($row['identifier_email'] != $row2['identifier_email'])) {
			...
			if ($ch == "b") {
				$overrides[] = ['record_id' => $row['record_id'], 'override_email' => $row2['identifier_email']];
			}
			echo "\n";
			break;
		}
