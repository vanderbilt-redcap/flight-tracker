...
if ($step == "initial") {
    echo MMAHelper::getInitialSetup($thisUrl, $phase, $menteeRecordId, $currInstance);
} else {
    echo MMAHelper::makePrefillDropdownHTML($surveysAvailableToPrefill, $uidString, $instances, $currInstance);
    echo MMAHelper::makeStepHTML($metadata, $step, $redcapData, $menteeRecordId, $currInstance, $phase, $notesFields, $userid2, $thisUrl, $token, $server, $pid);
}