...
function init_sparklines() {
    ...
    $(".sparkline_one").sparkline([2, 4, 3, 4, 5, 4, 5, 4, 3, 4, 5, 6, 4, 5, 6, 3, 5, 4, 5, 4, 5, 4, 3, 4, 5, 6, 7, 5, 4, 3, 5, 6], {
        type: 'bar',
        height: '125',
        barWidth: $('#theparticipantsgrid').width() / (32 + 8), //get width of participantsgrid and divide by count of institutions (ie. sparklines)+8px
        colorMap: {
            '7': '#a1a1a1'
        },
        barSpacing: 2,
...
$(document).ready(function() {
    ...
    $('.fc-content-skeleton .fc-event-container .fc-day-grid-event .fc-content').html("");
